...
def main(config=None):
    ...
    with wandb.init(config=config): # Initialisation of wandb
        ...
        dataset, label_names = load_data(dataset_name="wikiann") # Data Loading
...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(sweep_config, project="ner-sweep-self-attention")
    # main(args)
