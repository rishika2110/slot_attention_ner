...
class SlotAttention(nn.Module):
    ...
    def forward(self, inputs, num_slots = None):
        ...
        for _ in range(self.iters):
            ...
            slots = slots + self.mlp(self.norm_pre_ff(slots))  #bs, num_slots, hid_dim 
...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(sweep_config, project="ner-sweep-slot-attention-conll")
    # main(args)
